    ...
    <div className="min-h-screen bg-ink text-zinc-100">
      <main className="mx-auto flex max-w-3xl flex-col gap-10 px-4 py-8">
        <header className="space-y-3">
          ...
          <h1 className="font-sans text-4xl font-semibold text-zinc-100">OKC Box Score, distilled.</h1>
        ...
        {activeGame ? (
          <BoxScore summary={summary} loading={loadingSummary && !summary} fallbackGame={activeGame} />
        ) : (
          <div className="rounded-2xl border border-zinc-800 px-4 py-12 text-center font-mono text-sm text-zinc-500">
            No live or recent results. Tap Sync once the Thunder hit the floor.
          </div>
        )}
      </main>
    </div>
